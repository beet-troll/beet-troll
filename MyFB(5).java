...
public class MyFB {
	...
	static class Person {
		...
		public int hashCode () {
			int res = 31;
			res = 31 * res + ((Integer) age).hashCode();
			res = 31 * res + (null == name ? 0 : name.hashCode());
			return res;}}
	...
	public boolean queryFriendship (Person p1, Person p2) {
		...
		return !p1.equals(p2) && map.containsKey(p1) && map.get(p1).contains(p2);}
